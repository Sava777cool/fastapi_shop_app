...
@router.put("/{product_id}/", status_code=status.HTTP_205_RESET_CONTENT)
...
@router.patch("/{product_id}/", status_code=status.HTTP_206_PARTIAL_CONTENT)
async def update_product_partil(
